...
modelPath = f"models/hw03_medium_{n_epochs}epochs.ckpt"
lossesPath = "hw03_medium__loss&acc.csv"
predictionsPath = f"hw03_medium_{n_epochs}epochs_predict.csv"
#%%
...
if trainingEn:
    ...
    for epoch in range(n_epochs):
        ...
        epoch_valid_accs.append(valid_acc.item())

        # Print the information.
        print(f"[ Valid | {epoch + 1:03d}/{n_epochs:03d} ] loss = {valid_loss:.5f}, acc = {valid_acc:.5f}")

    with open(lossesPath, mode="w", encoding="utf8") as csvFile:
        csvFile.write("epoch,"+",".join([str(x) for x in range(n_epochs)])+"\n")
        csvFile.write("epoch_train_loss,"+",".join(str(x) for x in epoch_train_loss)+"\n")
        csvFile.write("epoch_train_accs,"+",".join(str(x) for x in epoch_train_accs)+"\n")
        csvFile.write("epoch_valid_loss,"+",".join(str(x) for x in epoch_valid_loss)+"\n")
        csvFile.write("epoch_valid_accs,"+",".join(str(x) for x in epoch_valid_accs)+"\n")
