...
data_dir = "F:\Workspace\Datasets\VoxCeleb"
batch_size = 100
n_workers = 0
valid_steps = 2000
warmup_steps = 1000
...
modelName = "hw04_hard"
checkpoint_path = "./models/hw04_hard/"
model_path = "./models/hw04_hard/model.ckpt"
output_path = "./models/hw04_hard/output.csv"
...
#     # print("1", out.shape)
#     out = out + self.FeedForwardLayer1(out)
#     # print("3-1", out.shape)
#     q = self.linear_q(out)
#     k = self.linear_k(out)
#     v = self.linear_v(out)
...
#     # print("3-3", k.shape)
#     # print("3-4", v.shape)
#     out = out + (v @ torch.transpose(k, -1, -2) @ q)
#     # print("3-5", out.shape)

#     out = out.permute(0, 2, 1)
#     # print("4-1", out.shape)
#     out = self.pointwiseConv1(out)
#     out = out.permute(0, 2, 1)
#     batchSize, length, d_model = out.shape
#     out = out.reshape(batchSize * length, 1, d_model)
#     # print("4-2", out.shape)
#     out = self.depthwiseConv(out)
#     out = out.reshape(batchSize, length, d_model)
#     # print("4-3", out.shape)
#     out = self.Acti_Norm(out)
#     # print("4-4", out.shape)
#     out = out + self.FeedForwardLayer2(out)
#     # out: (batch size, length, d_model)
#     # print("4", out.shape)
#     # out: (batch size, length, d_model)
#     # mean pooling
...
if __name__ == "__main__":
  ...
  for step in range(total_steps):
    ...
    if (step + 1) % save_steps == 0 and best_state_dict is not None:
        ckptPath = os.path.join(checkpoint_path, f"{modelName}_{step+1}steps.ckpt")
        prevCkptPath = os.path.join(checkpoint_path, f"{modelName}_{step+1-save_steps}steps.ckpt")
        checkpointData ={"model_dict" : model.state_dict(),
                         "optimizer_dict" : optimizer.state_dict(),
            }
        torch.save(checkpointData, ckptPath)
        if os.path.exists(prevCkptPath):
          os.remove(prevCkptPath)
